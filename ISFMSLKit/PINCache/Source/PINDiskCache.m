...
- (PINDiskCacheDeserializerBlock)defaultDeserializer
{
    return ^id(NSData * data, NSString *key){
        ...
        NSKeyedUnarchiver		*appleIsUpTheirOwnAssWithThisDeprecation = [[NSKeyedUnarchiver alloc] initForReadingFromData:data error:nil];
        appleIsUpTheirOwnAssWithThisDeprecation.requiresSecureCoding = NO;
        return [appleIsUpTheirOwnAssWithThisDeprecation decodeObjectForKey:NSKeyedArchiveRootObjectKey];
    };
}
